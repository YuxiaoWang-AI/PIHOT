...
if os.path.exists("./train_info.txt"):
    os.remove("./train_info.txt")
...
def main(cfg, gpus):
    ...
    net_encoder = ModelBuilder.build_encoder(
        arch=cfg.MODEL.arch_encoder.lower(), # resnet50dilated
        fc_dim=cfg.MODEL.fc_dim, # 2048
        weights=cfg.MODEL.weights_encoder) # ''
    net_decoder = ModelBuilder.build_decoder(
        cfg=cfg,
        arch=cfg.MODEL.arch_decoder.lower(), # c1
        fc_dim=cfg.MODEL.fc_dim, # 2048
        num_class=cfg.DATASET.num_class, # 18
